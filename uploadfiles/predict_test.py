...
#read file
# TEST_FILES = provider.getDataFiles('/Users/wangxue/gitpro/DL/pointcloud/PointCloudClassification/modelnet40_ply_hdf5_2048/test_files.txt')
#load model
model1 = load_model('PointCloudClassification/model/modelK15.h5') #load model

predict_data, predict_label = provider.load_h5('PointCloudClassification/modelnet40_ply_hdf5_2048/ply_data_test1.h5')
